/**
 * Editar referencias solicitud
 * Se Editan las referencias a partir de un array donde 
...
class ActualizarReferencias {
  ...
  castReferencia(ref) {
    return {
      ...
      celular: ref.celular,
      updated_by: process.env.USER_ID_DEFAULT,
      updated_at: new Date()
    };
  }
...
module.exports = ActualizarReferencias;
